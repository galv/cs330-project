...
SRC_DATA_DIR = "/home/rafael/supervised_peoples_speech/instructions_for_aligning_peoples_speech_test_set/Digital_Civic_Underground_Presented_by_Julia_Vallera"
TGT_MANIFEST = "a.json"
...
with open(TGT_MANIFEST, "w", encoding="utf8") as fout:
    ...
    for utt_id in tqdm.tqdm(utt_ids):
        ...
        data = {
            'audio_filepath': tgt_wav_file,
            'duration': float(sox.file_info.duration(tgt_wav_file)),
            'text': text,
        }
        print(data)
